...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_protos_2fagent_2fv1_2fagent_2eproto_metadata_getter(int index);
namespace v1 {
namespace agent {
...
class GetConfigBlobDataRequest PROTOBUF_FINAL :
...
class GetConfigBlobDataResponse PROTOBUF_FINAL :
...
class GetTeleopControlDataStreamRequest PROTOBUF_FINAL :
...
class GetTeleopControlDataStreamResponse PROTOBUF_FINAL :
...
inline void GetConfigBlobDataResponse::set_allocated_blob_data(::v1::model::BlobData* blob_data) {
  ...
  if (blob_data) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(blob_data)->GetArena();
    if (message_arena != submessage_arena) {
...
inline ::v1::model::ControlDatapoint* GetTeleopControlDataStreamResponse::_internal_mutable_control_datapoint() {
  ...
  if (control_datapoint_ == nullptr) {
    auto* p = CreateMaybeMessage<::v1::model::ControlDatapoint>(GetArena());
...
inline void GetTeleopControlDataStreamResponse::set_allocated_control_datapoint(::v1::model::ControlDatapoint* control_datapoint) {
  ...
  if (control_datapoint) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(control_datapoint)->GetArena();
    if (message_arena != submessage_arena) {
