...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_protos_2fmodel_2fv1_2ftext_2eproto_metadata_getter(int index);
namespace v1 {
namespace model {
class Json;
...
class Text PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_protos_2fmodel_2fv1_2ftext_2eproto_metadata_getter(kIndexInFileMessages);
  }
