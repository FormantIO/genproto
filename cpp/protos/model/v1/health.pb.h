...
class Health final :
 ...
 public:
  ...
  public:
  void clear_skew_ms();
  int64_t skew_ms() const;
  void set_skew_ms(int64_t value);
  private:
  int64_t _internal_skew_ms() const;
  void _internal_set_skew_ms(int64_t value);
  public:
...
inline int64_t Health::_internal_skew_ms() const {
  if (_internal_has_skew_ms()) {
    return clock_.skew_ms_;
  }
  return int64_t{0};
}
inline void Health::_internal_set_skew_ms(int64_t value) {
  if (!_internal_has_skew_ms()) {
    clear_clock();
    set_has_skew_ms();
  }
