...
class CommandRequest final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Timestamp* release_scrubber_time();
...
inline void CommandRequest::set_text(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_text()) {
    clear_parameter();
    set_has_text();
    parameter_.text_.InitDefault();
  }
  parameter_.text_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void CommandRequest::_internal_set_text(const std::string& value) {
  ...
  parameter_.text_.Set(value, GetArenaForAllocation());
}
...
inline void CommandRequest::set_allocated_text(std::string* text) {
  ...
  if (text != nullptr) {
    set_has_text();
    parameter_.text_.InitAllocated(text, GetArenaForAllocation());
  }
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* CommandRequest::mutable_scrubber_time() {
  ::PROTOBUF_NAMESPACE_ID::Timestamp* _msg = _internal_mutable_scrubber_time();
...
inline ::v1::model::FileInfo* CommandRequest::add_files() {
  ::v1::model::FileInfo* _add = _internal_add_files();
