...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_protos_2fmodel_2fv1_2fcommands_2eproto_metadata_getter(int index);
namespace v1 {
namespace model {
...
class CommandRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_protos_2fmodel_2fv1_2fcommands_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void CommandRequest::_internal_set_text(const std::string& value) {
  ...
  parameter_.text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void CommandRequest::set_text(const char* value) {
  ...
  parameter_.text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
...
inline std::string* CommandRequest::release_text() {
  ...
  if (_internal_has_text()) {
    clear_has_parameter();
    return parameter_.text_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  } else {
    return nullptr;
  }
}
