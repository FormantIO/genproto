...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_protos_2fmodel_2fv1_2fdatapoint_2eproto_metadata_getter(int index);
namespace v1 {
namespace model {
...
class Datapoint PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_protos_2fmodel_2fv1_2fdatapoint_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class ControlDatapoint PROTOBUF_FINAL :
...
inline ::v1::model::NumericSet* Datapoint::_internal_mutable_numeric_set() {
  if (!_internal_has_numeric_set()) {
    clear_data();
    set_has_numeric_set();
    data_.numeric_set_ = CreateMaybeMessage< ::v1::model::NumericSet >(GetArena());
  }
...
inline ::v1::model::Battery* Datapoint::_internal_mutable_battery() {
  if (!_internal_has_battery()) {
    clear_data();
    set_has_battery();
    data_.battery_ = CreateMaybeMessage< ::v1::model::Battery >(GetArena());
  }
...
inline ::v1::model::Video* Datapoint::_internal_mutable_video() {
  if (!_internal_has_video()) {
    clear_data();
    set_has_video();
    data_.video_ = CreateMaybeMessage< ::v1::model::Video >(GetArena());
  }
  return data_.video_;
}
