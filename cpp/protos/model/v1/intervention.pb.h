...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_protos_2fmodel_2fv1_2fintervention_2eproto_metadata_getter(int index);
namespace v1 {
namespace model {
...
class InterventionRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_protos_2fmodel_2fv1_2fintervention_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void LabelingRequest::_internal_set_instruction(const std::string& value) {
  ...
  instruction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void LabelingRequest::set_instruction(const char* value) {
  ...
  instruction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:v1.model.LabelingRequest.instruction)
}
inline void LabelingRequest::set_instruction(const char* value,
    size_t size) {
  
  instruction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* LabelingRequest::_internal_mutable_instruction() {
  ...
  return instruction_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
