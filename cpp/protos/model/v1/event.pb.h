...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_protos_2fmodel_2fv1_2fevent_2eproto_metadata_getter(int index);
namespace v1 {
namespace model {
...
class Event PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_protos_2fmodel_2fv1_2fevent_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class AgentEventConfiguration PROTOBUF_FINAL :
...
class AgentEventTrigger PROTOBUF_FINAL :
...
class PresenceEventTriggerCondition PROTOBUF_FINAL :
...
class ThresholdEventTriggerCondition PROTOBUF_FINAL :
...
class RegexEventTriggerCondition PROTOBUF_FINAL :
...
class BitsetEventTriggerCondition PROTOBUF_FINAL :
...
class BitsetCondition PROTOBUF_FINAL :
...
inline void Event::_internal_set_stream_type(const std::string& value) {
  ...
  stream_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void Event::set_stream_type(const char* value) {
  ...
  stream_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:v1.model.Event.stream_type)
}
inline void Event::set_stream_type(const char* value,
    size_t size) {
  
  stream_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:v1.model.Event.stream_type)
}
inline std::string* Event::_internal_mutable_stream_type() {
  
  return stream_type_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
inline ::v1::model::PresenceEventTriggerCondition* AgentEventTrigger::_internal_mutable_presence() {
  if (!_internal_has_presence()) {
    clear_condition();
    set_has_presence();
    condition_.presence_ = CreateMaybeMessage< ::v1::model::PresenceEventTriggerCondition >(GetArena());
  }
...
inline ::v1::model::ThresholdEventTriggerCondition* AgentEventTrigger::_internal_mutable_threshold() {
  if (!_internal_has_threshold()) {
    clear_condition();
    set_has_threshold();
    condition_.threshold_ = CreateMaybeMessage< ::v1::model::ThresholdEventTriggerCondition >(GetArena());
  }
...
inline ::v1::model::RegexEventTriggerCondition* AgentEventTrigger::_internal_mutable_regex() {
  if (!_internal_has_regex()) {
    clear_condition();
    set_has_regex();
    condition_.regex_ = CreateMaybeMessage< ::v1::model::RegexEventTriggerCondition >(GetArena());
  }
...
inline ::v1::model::BitsetEventTriggerCondition* AgentEventTrigger::_internal_mutable_bitset() {
  if (!_internal_has_bitset()) {
    clear_condition();
    set_has_bitset();
    condition_.bitset_ = CreateMaybeMessage< ::v1::model::BitsetEventTriggerCondition >(GetArena());
  }
