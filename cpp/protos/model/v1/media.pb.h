...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_protos_2fmodel_2fv1_2fmedia_2eproto_metadata_getter(int index);
namespace v1 {
namespace model {
class AudioChunk;
...
class Image PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_protos_2fmodel_2fv1_2fmedia_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void AudioChunk::_internal_set_chunk_data(const std::string& value) {
  ...
  chunk_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void AudioChunk::set_chunk_data(const char* value) {
  ...
  chunk_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void AudioChunk::set_chunk_data(const void* value,
  ...
  chunk_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* AudioChunk::_internal_mutable_chunk_data() {
  ...
  return chunk_data_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
inline void Video::set_raw(const void* value,
                             size_t size) {
  if (!_internal_has_raw()) {
    clear_data();
    set_has_raw();
