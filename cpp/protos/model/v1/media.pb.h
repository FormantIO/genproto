...
class RtcPointCloud final :
 ...
 public:
  ...
  explicit constexpr RtcPointCloud(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline RtcPointCloud* New() const final {
    return new RtcPointCloud();
  }

  RtcPointCloud* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class H264VideoFrame final :
 ...
 public:
  ...
  explicit constexpr H264VideoFrame(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_frame_data();
...
class AudioChunk final :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_format();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT std::string* release_chunk_data();
...
class TransformTree final :
 ...
 public:
  ...
  explicit constexpr TransformTree(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline TransformTree* New() const final {
    return new TransformTree();
  }

  TransformTree* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
void H264VideoFrame::set_frame_data(ArgT0&& arg0, ArgT... args) {
 ...
 frame_data_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void H264VideoFrame::_internal_set_frame_data(const std::string& value) {
  ...
  frame_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* H264VideoFrame::_internal_mutable_frame_data() {
  
  return frame_data_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* H264VideoFrame::release_frame_data() {
  ...
  return frame_data_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* AudioChunk::release_chunk_data() {
  ...
  return chunk_data_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
