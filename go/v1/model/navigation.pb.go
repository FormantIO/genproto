...
var file_protos_model_v1_navigation_proto_rawDesc = []byte{
	...
	,
...
var file_protos_model_v1_navigation_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_protos_model_v1_navigation_proto_goTypes = []interface{}{
	...
	(*Goal)(nil),          // 6: v1.model.Goal
	(*GoalID)(nil),        // 7: v1.model.GoalID
	(*PointCloud)(nil),    // 8: v1.model.PointCloud
	(*Transform)(nil),     // 9: v1.model.Transform
	(*Twist)(nil),         // 10: v1.model.Twist
}
var file_protos_model_v1_navigation_proto_depIdxs = []int32{
	...
	8,  // 2: v1.model.Localization.point_clouds:type_name -> v1.model.PointCloud
	5,  // 3: v1.model.Localization.path:type_name -> v1.model.Path
	6,  // 4: v1.model.Localization.goal:type_name -> v1.model.Goal
	9,  // 5: v1.model.Odometry.pose:type_name -> v1.model.Transform
	10, // 6: v1.model.Odometry.twist:type_name -> v1.model.Twist
	9,  // 7: v1.model.Odometry.world_to_local:type_name -> v1.model.Transform
	9,  // 8: v1.model.Map.origin:type_name -> v1.model.Transform
	9,  // 9: v1.model.Map.world_to_local:type_name -> v1.model.Transform
	4,  // 10: v1.model.Map.occupancy_grid:type_name -> v1.model.OccupancyGrid
	9,  // 11: v1.model.Path.world_to_local:type_name -> v1.model.Transform
	9,  // 12: v1.model.Path.poses:type_name -> v1.model.Transform
	9,  // 13: v1.model.Goal.world_to_local:type_name -> v1.model.Transform
	9,  // 14: v1.model.Goal.pose:type_name -> v1.model.Transform
