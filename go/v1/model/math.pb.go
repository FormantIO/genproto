...
var file_protos_model_v1_math_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x01, 0x52, 0x01, 0x7a, 0x12, 0x0c, 0x0a, 0x01, 0x77, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x01, 0x52, 0x01, 0x77, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_protos_model_v1_math_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_protos_model_v1_math_proto_goTypes = []interface{}{
	...
	(*Quaternion)(nil),      // 9: v1.model.Quaternion
}
var file_protos_model_v1_math_proto_depIdxs = []int32{
	...
	9, // 5: v1.model.Transform.rotation:type_name -> v1.model.Quaternion
