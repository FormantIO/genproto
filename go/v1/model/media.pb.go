...
var file_protos_model_v1_media_proto_rawDesc = []byte{
	...
	0x42, 0x06, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x5b, 0x0a, 0x0e, 0x48, 0x32, 0x36, 0x34,
	...
	0x2f, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x74, 0x49, 0x4f, 0x2f, 0x67, 0x65, 0x6e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x62,
...
var file_protos_model_v1_media_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_protos_model_v1_media_proto_goTypes = []interface{}{
	(*Image)(nil),          // 0: v1.model.Image
	(*PointCloud)(nil),     // 1: v1.model.PointCloud
	(*H264VideoFrame)(nil), // 2: v1.model.H264VideoFrame
	(*AudioChunk)(nil),     // 3: v1.model.AudioChunk
	(*Video)(nil),          // 4: v1.model.Video
	(*Transform)(nil),      // 5: v1.model.Transform
}
var file_protos_model_v1_media_proto_depIdxs = []int32{
	5, // 0: v1.model.PointCloud.world_to_local:type_name -> v1.model.Transform
...
func file_protos_model_v1_media_proto_init() {
	...
	file_protos_model_v1_media_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*Video_Url)(nil),
		(*Video_Raw)(nil),
	}
	type x struct{}
